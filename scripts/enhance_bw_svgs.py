...
def enhance_svg(filepath):
    ...
    # Replace thick strokes with clean, thin 1.2 stroke-width for detailed line art
    new_content = re.sub(r'stroke-width="2\.[0-9]+"', 'stroke-width="1.2"', content)
    new_content = re.sub(r'stroke-width="3\.[0-9]+"', 'stroke-width="1.2"', new_content)
    new_content = re.sub(r'stroke-width="2"', 'stroke-width="1.2"', new_content)
